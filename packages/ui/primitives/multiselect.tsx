...
const MultiSelect = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50 relative min-h-[38px] rounded-md border border-muted-foreground/30 bg-card text-sm outline-none transition-[color,box-shadow] focus-within:border-transparent focus-within:ring-1 focus-within:ring-primary/50',
          {
      ...
      >
        <div className="flex flex-wrap gap-1">
          ...
          <button
            ...
            className={cn(
              'absolute end-0 top-0 flex size-9 items-center justify-center rounded-md border border-transparent text-muted-foreground/80 outline-none transition-[color,box-shadow] hover:text-foreground focus-visible:border-primary focus-visible:ring-1 focus-visible:ring-primary/50',
              (hideClearAllButton ||
                disabled ||
                selected.length < 1 ||
      ...
      <div className="relative">
        <div
          className={cn(
            'absolute top-2 z-10 w-full overflow-hidden rounded-md border border-muted-foreground/30 bg-card',
